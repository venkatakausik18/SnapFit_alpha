...
def main():
    ...
    parser.add_argument('--lora_name', type=str, default="dev_lora_garment_reconstruction.safetensors", help='choose from dev_lora_any2any_alltasks.safetensors, dev_lora_any2any_tryon.safetensors and dev_lora_garment_reconstruction.safetensors')
